...
Divvy_Chi = readtable('Divvy_Trips_2019_Q3.csv');
...
%% read data for LA
Metro_LA = readtable('metro-bike-share-trips-2019-q3.csv');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 450000]);
...
sgtitle('Histogram of trip duration (Q3 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure1,'Histogram of trip duration_Q3_2019.png');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 260000]);
title('Chicago','FontSize', 15');grid on
...
sgtitle('Daily Demand Trend (Q3 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure2,'DailyDemandTrend_Q3_2019.png');
...
sgtitle('Monthly Demand Trend (Q3 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure3,'MonthlyTrend_Q3_2019.png');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 200000]);
title('Chicago','FontSize', 15');grid on
...
sgtitle('Hourly Demand Trend (Q3 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure4,'HourlyTrend_Q3_2019.png');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 400000]);
title('Chicago','FontSize', 15');grid on
...
sgtitle('Age vs count of users (Q3 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure5,'AgeTrend_Q3_2019.png');
...
sgtitle('Subscribers vs Daily Customers (Q3 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure6,'subscriberVsCustomer_Q3_2019.png');
