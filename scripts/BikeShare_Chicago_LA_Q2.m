...
Divvy_Chi = readtable('Divvy_Trips_2019_Q2.csv');
...
%% read data for LA
Metro_LA = readtable('metro-bike-share-trips-2019-q2.csv');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 350000]);
...
sgtitle('Histogram of trip duration (Q2 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure1,'Histogram of trip duration_Q2_2019.png');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 180000]);
title('Chicago','FontSize', 15');grid on
...
sgtitle('Daily Demand Trend (Q2 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure2,'DailyDemandTrend_Q2_2019.png');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 130000]);
title('Chicago','FontSize', 15');grid on
...
sgtitle('Monthly Demand Trend (Q2 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure3,'MonthlyTrend_Q2_2019.png');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 150000]);
title('Chicago','FontSize', 15');grid on
...
sgtitle('Hourly Demand Trend (Q2 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure4,'HourlyTrend_Q2_2019.png');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 250000]);
title('Chicago','FontSize', 15');grid on
...
sgtitle('Age vs count of users (Q2 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure5,'AgeTrend_Q2_2019.png');
...
sgtitle('Subscribers vs Daily Customers (Q2 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure6,'subscriberVsCustomer_Q2_2019.png');
