...
Divvy_Chi = readtable('Divvy_Trips_2019_Q4.csv');
...
%% read data for LA
Metro_LA = readtable('metro-bike-share-trips-2019-q4.csv');
...
sgtitle('Histogram of trip duration (Q4 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure1,'Histogram of trip duration_Q4_2019.png');
...
sgtitle('Daily Demand Trend (Q4 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure2,'DailyDemandTrend_Q4_2019.png');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 120000]);
title('Chicago','FontSize', 15');grid on
...
sgtitle('Monthly Demand Trend (Q4 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure3,'MonthlyTrend_Q4_2019.png');
...
ylabel('Count of users', 'FontSize',12'); ylim([0 100000]);
title('Chicago','FontSize', 15');grid on
...
sgtitle('Hourly Demand Trend (Q4 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure4,'HourlyTrend_Q4_2019.png');
...
sgtitle('Age vs count of users (Q4 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure5,'AgeTrend_Q4_2019.png');
...
sgtitle('Subscribers vs Daily Customers (Q4 2019)','FontSize',20)
annotation('textbox', [0.80, 0.87, 0.1, 0.1], 'String',"Script Rev:10(March 19,2021)",'FontSize',9)
saveas(figure6,'subscriberVsCustomer_Q4_2019.png');
